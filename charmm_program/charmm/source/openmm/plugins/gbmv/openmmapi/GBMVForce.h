#ifndef OPENMM_GBMVFORCEFIELD_H_
#define OPENMM_GBMVFORCEFIELD_H_
...
/**
 * This class implements an implicit solvation force using the GBMV model.
 * 
 * To use this class, create a GBMVForce object, then call addParticle() once for each particle in the
 * System to define its parameters.  The number of particles for which you define GBMV parameters must
 ...
 * when combined with GBMV.
 */

class GBMVForce : public OpenMM::Force {
public:
    /**
    ...
    /**
     * Add the GBMV parameters for a particle.  This should be called once for each particle
     * in the System.  When it is called for the i'th time, it specifies the parameters for the i'th particle.
     *
     * @param charge         the charge of the particle, measured in units of the proton charge
     * @param radius         the GBMV radius of the particle, measured in nm
     */
    ...
    /**
     * get the phenomenological constant AA0 for the GBMV delta-G0 term.
     */
    double getAA0() const {
        return AA0;
    }
    /**
     * set the phenomenological constant AA0 for the GBMV delta-G0 term.
     */
    void setAA0(double value) {
        AA0 = value;
    }
    /**
     * get the phenomenological constant AA1 for the GBMV delta-G1 term.
     */
    double getAA1() const {
        return AA1;
    }
    /**
     * set the phenomenological constant AA1 for the GBMV delta-G1 term.
     */
    ...
    /**
     * Get the Debye-Huckel length that adds a salt concentration to GBMV.
     */
    double getDebyeHuckelLength() const {
        return kappa;
    }
    /**
     * Set the Debye-Huckel length that adds a salt concentration to GBMV.
     */
    ...
    double getBETA_GBMV2() const {
        return BETA_GBMV2;
    }
    void setBETA_GBMV2(double value) {
        BETA_GBMV2 = value;
    }
    double getLAMBDA_GBMV2() const {
        return LAMBDA_GBMV2;
    }
    void setLAMBDA_GBMV2(double value) {
        LAMBDA_GBMV2 = value;
    }
    double getALPHA_GBMV2() const {
        return ALPHA_GBMV2;
    }
    void setALPHA_GBMV2(double value) {
        ALPHA_GBMV2 = value;
    }
    double getSLOPE_GBMV2() const {
        return SLOPE_GBMV2;
    }
    void setSLOPE_GBMV2(double value) {
        SLOPE_GBMV2 = value;
    }
    double getSHIFT_GBMV2() const {
        return SHIFT_GBMV2;
    }
    void setSHIFT_GBMV2(double value) {
        SHIFT_GBMV2 = value;
    }
    double getHSX1_GBMV2() const {
        return HSX1_GBMV2;
    }
    void setHSX1_GBMV2(double value) {
        HSX1_GBMV2 = value;
    }
    double getHSX2_GBMV2() const {
        return HSX2_GBMV2;
    }
    void setHSX2_GBMV2(double value) {
        HSX2_GBMV2 = value;
    }
    double getONX_GBMV2() const {
        return ONX_GBMV2;
    }
    void setONX_GBMV2(double value) {
        ONX_GBMV2 = value;
    }
    double getOFFX_GBMV2() const {
        return OFFX_GBMV2;
    }
    void setOFFX_GBMV2(double value) {
        OFFX_GBMV2 = value;
    }
    double getP1_GBMV2() const {
        return P1_GBMV2;
    }
    void setP1_GBMV2(double value) {
        P1_GBMV2 = value;
    }
    double getP2_GBMV2() const {
        return P2_GBMV2;
    }
    void setP2_GBMV2(double value) {
        P2_GBMV2 = value;
    }
    double getP3_GBMV2() const {
        return P3_GBMV2;
    }
    void setP3_GBMV2(double value) {
        P3_GBMV2 = value;
    }
    double getP6_GBMV2() const {
        return P6_GBMV2;
    }
    void setP6_GBMV2(double value) {
        P6_GBMV2 = value;
    }
    int getCUTNUM_GBMV2() const {
        return CUTNUM_GBMV2;
    }
    void setCUTNUM_GBMV2(int value) {
        CUTNUM_GBMV2 = value;
    }
    // END GBMV2
    /**
    ...
    /**
     * Get the cuton distance (in nm) being used for nonbonded interactions.  If the NonbondedMethod in use
     * is NoCutoff, this value will have no effect.
     *
     * @return the cuton distance, measured in nm
     */
    double getCutonDistance() const;
    /**
     * Set the cuton distance (in nm) being used for nonbonded interactions.  If the NonbondedMethod in use
     * is NoCutoff, this value will have no effect.
     *
     * @param distance    the cuton distance, measured in nm
     */
    void setCutonDistance(double distance);
    /**
    ...
    bool usesPeriodicBoundaryConditions() const {
        return nonbondedMethod == GBMVForce::CutoffPeriodic;
    }
protected:
...
private:
    ...
    bool useCPHMD;
    double cutonDistance, cutoffDistance, solventDielectric, soluteDielectric, surfaceAreaEnergy,
        swLen, AA0, AA1, kappa, tempTheta, timestepTheta, globalPH, massTheta, pHbeta,
        membraneThickness, membraneSwLen, rfDielectric,
        BETA_GBMV2, LAMBDA_GBMV2, ALPHA_GBMV2, SLOPE_GBMV2, SHIFT_GBMV2,
 ...
 * @private
 */
class GBMVForce::TitratingGroupInfo {
public:
 ...
 * @private
 */
class GBMVForce::ParticleCphmdInfo {
public:
    int titrateResID;
 ...
 * @private
 */
class GBMVForce::NonbondedExceptionFixes {
public:
    int atom1, atom2;
...
#endif /*OPENMM_GBMVFORCEFIELD_H_*/
